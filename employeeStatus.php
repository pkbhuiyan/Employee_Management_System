...
<?php 
 ...
 if (isset($_POST['search_btn'])) {
   ...
   $search=$_POST['input'];  
    if ($search == '') {
      # code...
      $select1="SELECT employee_professional_info.id, employee_professional_info.Department, employee_professional_info.Designation, employee_professional_info.Salary, employee_professional_info.leave_remaining,employee_personal_info.Name
        FROM employee_professional_info INNER JOIN employee_personal_info 
        ON employee_personal_info.id=employee_professional_info.id";
      ...
      <tbody>
            <?php 
             ...
             while ( $row = $data->fetch(PDO::FETCH_ASSOC) ) {
              ...
              // echo "<td>"."<a href='view.php<?php echo '?id='.'$id'; '>"."<i class='fa fa-eye'  aria-hidden='true'></i></a>".
              // "<span>"."&nbsp&nbsp/&nbsp&nbsp".
              // "</span>"."<a href='edit.php<?php echo '?id='.'$id'; '>"."<i class='fa fa-pencil' aria-hidden='true'></i></a>"."</td>";
              // echo "</tr>";
              // } 
            ?>
            ...
            <tr>
                ...
                <td style="text-align:center; word-break:break-all; width:450px;"> <?php echo $row ['Salary']; ?></td>
                <td style="text-align:center; word-break:break-all; width:450px;"> 40 </td>
                <td style="text-align:center; word-break:break-all; width:450px;"> <?php echo $row ['leave_remaining']; ?></td>
